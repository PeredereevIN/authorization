...
const catch_errors_util_1 = require("../common/utils/catch-errors.util");
const zod_1 = require("zod");
class SessionController {
    constructor(sessionService) {
        this.getAllSession = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
        ...
        this.getSession = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
            const sessionId = req?.sessionId;
            if (!sessionId) {
                throw new catch_errors_util_1.NotFoundException("Session ID not found. Please log in.");
            }
        ...
        this.deleteSession = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
