...
class NotFoundException extends AppError_util_1.AppError {
...
class BadRequestException extends AppError_util_1.AppError {
    constructor(message = "Bad Request", errorCode) {
        super(message, http_config_1.HTTPSTATUS.BAD_REQUEST, errorCode);
    }
}
exports.BadRequestException = BadRequestException;
class UnauthorizedException extends AppError_util_1.AppError {
...
class InternalServerException extends AppError_util_1.AppError {
...
class HttpException extends AppError_util_1.AppError {
